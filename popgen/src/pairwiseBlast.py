...
def callProc(gene,seqfile,dbfile):
	...
	blastp_cline = NcbiblastnCommandline(query="temp"+gene+".fa",db=dbfile,evalue=1e-10,
...
def main(argv):
	...
	Parallel(n_jobs=int(threads))(delayed(callProc)(seq,seqfile,dbfile) for seq in seq_IDs)
